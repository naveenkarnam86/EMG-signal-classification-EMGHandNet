...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB1_codes/nina_prep_python/prep_hht_wave/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB1_codes/prep_hht_wave/Total_process_TT/';
mkdir(destdirectory);   %create the directory
file1 = sprintf('nina_pro_naveen_DB1_HHT_wave_train.csv');
fulldestination = fullfile(destdirectory, file1);%name file relative to that directory
csvwrite(fulldestination, train_process_data); 
file2 = sprintf('nina_pro_naveen_DB1_HHT_wave_test.csv');
...
file3 = sprintf('nina_pro_naveen_DB1_HHT_wave_train_mat.mat');
fulldestination = fullfile(destdirectory, file3);
save(fulldestination, 'train_process_data');
file4 = sprintf('nina_pro_naveen_DB1_HHT_wave_test_mat.mat');
