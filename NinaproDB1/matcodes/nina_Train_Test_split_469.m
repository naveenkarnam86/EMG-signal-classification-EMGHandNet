...
[Train_raw_data Test_raw_data] =fn_final_train_test_split_469(Total_data,Trial_length);
...
destdirectory = 'C:\Users\Naveen\Google Drive\codes\nina_prep_python\Train_Test_split_data_469\';
mkdir(destdirectory);   %create the director
file = sprintf('nina_sEMG_Train_Test_split_469.mat');
