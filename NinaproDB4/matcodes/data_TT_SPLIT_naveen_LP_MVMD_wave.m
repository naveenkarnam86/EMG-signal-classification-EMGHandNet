...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_MVMD_wave/sub_wise_process_TT/';
...
% disp(sub);
% end
% destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_EMD_hht_wave/Total_process_TT/';
