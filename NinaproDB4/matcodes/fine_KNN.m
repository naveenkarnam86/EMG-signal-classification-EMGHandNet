...
fullMatFileName = fullfile(destdirectory,  'nina_DB4_sEMG_feat_data.mat')
...
% Auto-generated by MATLAB on 02-Sep-2021 12:48:14
...
Energy_DB4_test_data = Test_save_categorical(1:m3-1,:);
destdirectory = '/media/naveen/nav/mat_codes/nina_DB4_codes/nina_prep_naveen/energy/';
mkdir(destdirectory);   %create the director
file1 = sprintf('energy_DB4_test.csv');
...
csvwrite(fulldestination,Energy_DB4_test_data);
