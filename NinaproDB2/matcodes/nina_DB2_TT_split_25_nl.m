...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB2_codes/prep_nl/sub_wise_process_TT/';
...
file3 = sprintf('nina_pro_nl_DB2_Train_mat.mat');
fulldestination = fullfile(destdirectory, file3);
save(fulldestination, 'Train_process_data');
file4 = sprintf('nina_pro_nl_DB2_Test_mat.mat');
