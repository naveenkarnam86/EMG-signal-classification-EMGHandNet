...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB2_codes/prep_nb/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB2_codes/prep_nb/Total_process_TT/';
mkdir(destdirectory);   %create the director
