...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB2_codes/preprocess/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/nina_DB2_codes/preprocess/Total_process_TT/';
mkdir(destdirectory);   %create the director
