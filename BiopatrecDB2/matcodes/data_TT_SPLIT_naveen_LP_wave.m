...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_wave/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_wave/Total_process_TT/';
mkdir(destdirectory);   %create the directory
file1 = sprintf('Biopatrec_26c_17s_LP_wave_train.csv');
fulldestination = fullfile(destdirectory, file1);%name file relative to that directory
csvwrite(fulldestination, train_process_data); 
file2 = sprintf('Biopatrec_26c_17s_LP_wave_test.csv');
...
file3 = sprintf('Biopatrec_26c_17s_LP_wave_train_mat.mat');
fulldestination = fullfile(destdirectory, file3);
save(fulldestination, 'train_process_data');
file4 = sprintf('Biopatrec_26c_17s_LP_wave_test_mat.mat');
