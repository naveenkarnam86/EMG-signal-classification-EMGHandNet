...
N_sub = 17;
destdirectory1 = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_MVMD_wave/sub_wise_process_TT/';
for sub=1:N_sub
...
destdirectory2 = '/media/naveen/nav/mat_codes/BioPatRec/prep_LP_MVMD_wave/Total_process_TT/';
mkdir(destdirectory2);   %create the directory
file1 = sprintf('Biopatrec_26c_17s_LP_MVMD_wave_train.csv');
...
file3 = sprintf('Biopatrec_26c_17s_LP_MVMD_wave_train_mat.mat');
...
file2 = sprintf('Biopatrec_26c_17s_LP_MVMD_wave_test.csv');
...
file4 = sprintf('Biopatrec_26c_17s_LP_MVMD_wave_test_mat.mat');
