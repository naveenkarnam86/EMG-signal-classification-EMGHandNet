function  [Train_all Test_all] =fn_final_train_test_split_13(rawdata,Trial_length,n_class)
Train_all=[];
valid_all=[];
Test_all=[];
[m,n]=size(rawdata);
% step = Trial_length;
    for i=1:1:n_class    
       ...
       [train test] = fn_Train_test_split_classwise_13(classwisedata_TS,n_trials_per_class);
