...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_wave_WR/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/prep_wave_WR/Total_process_TT/';
mkdir(destdirectory);   %create the directory
file1 = sprintf('Biopatrec_26class_17sub_train_WR.csv');
fulldestination = fullfile(destdirectory, file1);%name file relative to that directory
csvwrite(fulldestination, train_process_data); 
file2 = sprintf('Biopatrec_26class_17sub_test_WR.csv');
