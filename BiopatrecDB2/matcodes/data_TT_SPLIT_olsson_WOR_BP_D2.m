...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/olsson_prep_WOR_BP_D2/sub_wise_process_TT/';
...
destdirectory = '/media/naveen/nav/mat_codes/BioPatRec/olsson_prep_WOR_BP_D2/Total_process_TT/';
mkdir(destdirectory);   %create the directory
file1 = sprintf('Biopatrec_olsson_WOR_BP_D2_train.csv');
fulldestination = fullfile(destdirectory, file1);%name file relative to that directory
csvwrite(fulldestination, train_process_data); 
file2 = sprintf('Biopatrec_olsson_WOR_BP_D2_test.csv');
